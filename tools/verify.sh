...
# Mirrors BeamFragmentSource() in Beam.cpp and FieldProbeSource() in FieldGLSL.cpp.
# 0 and 1 are the two unnamed raw strings in FieldGLSL.cpp, in source order.
ASSEMBLED = {
	"BeamFragment":       [ "#version 410 core\n", "kFieldUniforms", "kBeamBody", "kFieldFunction", "kBeamMain" ],
	"FieldProbeFragment": [ "#version 410 core\n", "kFieldUniforms", 0, "kFieldFunction", 1 ],
}
