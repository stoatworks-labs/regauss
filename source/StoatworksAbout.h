...
{
    inline constexpr auto name = "(re)gauss";
    inline constexpr auto slug = "regauss";
    inline constexpr auto hook = "CRT interference and degaussing for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/regauss/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/regauss/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/regauss";
