/**
    ...
    `CFFGLPluginInfo` that Regauss.cpp registers at static-initialisation time.
    ...
    binary: which build it is.
        ...
        strings Regauss.bundle/Contents/MacOS/Regauss | grep regauss
*/

extern "C" const char* RegaussBuildStamp()
{
	return "regauss " REGAUSS_VERSION " built " __DATE__ " " __TIME__;
}
